...
class DoubleNumberEntryControl: ConstraintLayout {
    ...
    init {
        val view = LayoutInflater.from(context).inflate(R.layout.weight_control, this, false)
        addView(view)
        setupControls()
    }
    ...
    private fun setupControls() {
        ...
        editReps.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(p0: Editable?) {
                ...
                value = if (editedValue != "") editedValue.toDouble() else 0.0
            }
